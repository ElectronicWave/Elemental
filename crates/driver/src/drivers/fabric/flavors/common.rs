...
pub(super) trait FlavorBehavior {
...
pub(super) enum LibraryReplacementFamily {
    Asm,
    Lwjgl2,
}

pub(super) fn merge_profile_with_behavior(
...
fn metadata_has_replaced_library_conflicts<B: FlavorBehavior + ?Sized>(
    behavior: &B,
    metadata: &PistonMetaData,
) -> bool {
